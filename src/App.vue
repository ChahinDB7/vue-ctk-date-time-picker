<template>
  <div id="app" :class="{ dark: darkMode }">
    <div id="vueCtkDateTimePicker" class="ctk-date-time-picker">
      <header>
        <img v-if="!darkMode" src="@/assets/logo.png" alt="logo-chronotruck" />
        <img v-else src="@/assets/logo-dark.png" alt="logo-chronotruck-dark" />
        ...
        <button class="lm-btn lm-btn-success" @click="darkMode = !darkMode">
          {{ darkMode ? 'Disable' : 'Enable' }} Dark Mode
        </button>
      </header>
      <div v-if="devMode" class="container">
        <div class="flex flex-wrap align-center justify-content-center">
          <div :class="{ dark: darkMode }" class="component-container">
      ...
      <div v-else class="container">
        <div class="components-container flex flex-wrap">
          ...
          >
            ...
            <hr />
            <button class="lm-btn option" @click="demo.editOption = !demo.editOption">
              Edit options
            </button>
            <div v-show="demo.editOption" class="flex flex-wrap component options">
              <div class="flex-1">
                ...
                >
                  <input v-model="demo.options[str]" type="text" />
                  <span style="margin-left: 15px">
                    {{ str }}
                  </span>
                </div>
                <h4 style="margin-bottom: 10px">Integer options</h4>
                <div v-for="int in intOptions" :key="int" class="flex" style="margin-bottom: 10px">
                  <input v-model="demo.options[int]" type="number" />
                  <span style="margin-left: 15px">
                    {{ int }}
                  </span>
                </div>
              ...
              <div class="flex-1">
                ...
                >
                  ...
                  <span style="margin-left: 15px">
                    {{ opt }}
                    {{
                      opt === 'onlyDate' || opt === 'onlyTime' || opt === 'range'
                        ? '(disabled)'
                        : ''
                    }}
                  </span>
              ...
              <div>
                <h4 style="margin-bottom: 10px">Options not editable (is Array)</h4>
                <span v-for="opt in optionsNotEditable" :key="opt">
                  {{ opt + ', ' }}
                </span>
              </div>
            </div>
            <div class="component">
              ...
              >
                ...
                <template
                  v-else-if="
                    demo.options && demo.options.slot && demo.options.slot.type === 'button'
                  "
...
<script>
import CtkDateTimePicker from '@VueCtkDateTimePicker/index.vue'
